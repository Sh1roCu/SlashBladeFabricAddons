...
public class ThrustEdgeEntity extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(ThrustEdgeEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(ThrustEdgeEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(ThrustEdgeEntity.class, EntityDataSerializers.VECTOR3);

    public ThrustEdgeEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
