...
public class SoulEdgeEntityButerfly extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(SoulEdgeEntityButerfly.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(SoulEdgeEntityButerfly.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(SoulEdgeEntityButerfly.class, EntityDataSerializers.VECTOR3);

    public SoulEdgeEntityButerfly(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
