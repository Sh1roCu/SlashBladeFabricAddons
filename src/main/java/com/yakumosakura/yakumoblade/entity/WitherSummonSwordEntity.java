...
public class WitherSummonSwordEntity extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(WitherSummonSwordEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(WitherSummonSwordEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(WitherSummonSwordEntity.class, EntityDataSerializers.VECTOR3);

    public WitherSummonSwordEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
