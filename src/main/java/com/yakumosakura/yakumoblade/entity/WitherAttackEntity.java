...
public class WitherAttackEntity extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(WitherAttackEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(WitherAttackEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(WitherAttackEntity.class, EntityDataSerializers.VECTOR3);

    public WitherAttackEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
