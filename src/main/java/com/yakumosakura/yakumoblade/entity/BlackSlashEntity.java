...
public class BlackSlashEntity extends absNeoSummonSword {
    private static final EntityDataAccessor<Boolean> IT_FIRED = SynchedEntityData.defineId(BlackSlashEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Float> SPEED = SynchedEntityData.defineId(BlackSlashEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<Vector3f> OFFSET = SynchedEntityData.defineId(BlackSlashEntity.class, EntityDataSerializers.VECTOR3);
    long fireTime = -1;

    public BlackSlashEntity(EntityType<? extends Projectile> entityTypeIn, Level worldIn) {
