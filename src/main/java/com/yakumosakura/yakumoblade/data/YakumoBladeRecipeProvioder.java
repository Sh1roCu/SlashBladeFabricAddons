...
public class YakumoBladeRecipeProvioder extends FabricRecipeProvider {
    public YakumoBladeRecipeProvioder(FabricDataOutput output) {
        super(output);
    }
    ...
    public void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SlashBladeShapedRecipeBuilder.shaped(YakumoBladeBuiltInRegsitryTouHou.YUYUKO.location())
                ...
                .unlockedBy(getHasName(SBItems.SLASHBLADE), has(SBItems.SLASHBLADE)).save(withConditions(consumer, DefaultResourceConditions.allModsLoaded(TwilightForestMod.ID)));
        ...
        SlashBladeShapedRecipeBuilder.shaped(YakumoBladeBuiltInRegsitryTouHou.YAKUMOSAKURA3.location())
                ...
                .unlockedBy(getHasName(SBItems.SLASHBLADE), has(SBItems.SLASHBLADE)).save(withConditions(consumer, DefaultResourceConditions.allModsLoaded(Yakumoblade.TLM)));
