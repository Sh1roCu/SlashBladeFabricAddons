...
public class SBAEntitiesRegistry {
    ...
    public static void init() {
        WaterDrive = register(new ResourceLocation(SlashBladeAddon.MODID, "water_drive"), EntityType.Builder
                .of(EntityWaterDrive::new, MobCategory.MISC).sized(0.9F, 0.9F).clientTrackingRange(4)
                .updateInterval(20)
                .build("water_drive"));

        LightingSwords = register(new ResourceLocation(SlashBladeAddon.MODID, "lighting_swords"), EntityType.Builder
